...
public class TgroupUserBaseDto implements java.io.Serializable {
	private static final long serialVersionUID = 5454155825314635342L;
	private String sortColumns = "";
	//alias
	public static final String TABLE_ALIAS = "TgroupUser";
	...
	public boolean equals(Object obj) {
		if(obj instanceof TgroupUserBaseDto == false) return false;
		if(this == obj) return true;
		TgroupUserBaseDto other = (TgroupUserBaseDto)obj;
